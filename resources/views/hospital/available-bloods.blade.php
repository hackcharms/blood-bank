...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Avilable Blood</h1>
    <!-- DataTales Example -->
                                    ...
                                    <tr role="row" class="even">
                                        ...
                                        <td>
                                            <form action="{{route('hospital.addBlood')}}" method="post">
                                                ...
                                                <input type="hidden" name="blood_group" value="{{$blood->blood_group}}">
                                                    <input type="number" min="0" name="unit" class="form-control" placeholder="Units" aria-label="Units" aria-describedby="button-addon2">
